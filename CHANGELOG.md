...
- **patches:** add "Open Patch Details to the Side" to the patch item's right-click menu, opening the details as a kept panel beside the current editor. Alt-clicking the item's inline "Open Patch Details" button does the same
